...
class LoginScreenState extends State<LoginScreen> {
  ...
  StreamController<ButtonSubmitEvent> loginButtonController = new StreamController<ButtonSubmitEvent>.broadcast();
  ...
  Widget loginButton(LoginBloc loginBloc) {
    return ButtonWidget(controller: loginButtonController, defaultHintText: LocalizationsUtil.of(context).translate('Đăng nhập'), callback: () async {
            ...
            children: <Widget>[
              ...
              TextFormField(
                ...
                onChanged: (String username) {
                  ...
                  if (fusername.text.length >= fusernameLength && fpassword.text.length >= fpassLength) {
                    loginButtonController.sink.add(ButtonSubmitEvent(true));
                  }
                  if (fusername.text.length <= fusernameLength-1 || fpassword.text.length <= fpassLength-1) {
                          ...
                          builder: (
                            ...
                            return Column(
                              ...
                              children: <Widget>[
                                ...
                                errorText != null ? Row(children: [
                                  Text(errorText,style: TextStyle(color: Colors.red),)]) : Center(),
