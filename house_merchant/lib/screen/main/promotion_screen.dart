      ...
      child: Column(
        ...
        children: <Widget>[
              ...
              Expanded(
                child: Container(child: Column(
                  ...
                  children: <Widget>[
                    Row(
                      children: <Widget>[
                        TextLimitWidget(promotionModel.promotionTitle, maxLines: 2, style: new TextStyle(
          ...
          Row(
            ...
            children: <Widget>[
              Text('0/40', style: new TextStyle(
                fontSize: ThemeConstant.label_font_size,
                fontFamily: ThemeConstant.form_font_family_display,
                color: ThemeConstant.black_color,
              )),
              Text('Từ 12:00 - 01/01/2020', style: new TextStyle(
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: <Widget>[
              Text('Lượt sử dụng', style: new TextStyle(
                fontSize: ThemeConstant.form_font_small,
                fontFamily: ThemeConstant.form_font_family_display,
                color: ThemeConstant.grey_color,
              )),
              Text('Đến 23:59 - 20/10/2019', style: new TextStyle(
                fontSize: ThemeConstant.form_font_small,
                fontFamily: ThemeConstant.form_font_family_display,
                color: ThemeConstant.grey_color,
              )),
          ...
          Expanded(
            child: Container(
              child: ListView.builder(
                shrinkWrap: true,
                itemBuilder: (c, index) {
                  return Padding(child: this.itemCard(products[index]), padding: EdgeInsets.only(left: this._padding, right: this._padding, top: 10, bottom: 10),);
