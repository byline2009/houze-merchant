...
class MainScreenState extends State<MainScreen> {
  ...
  Widget bottomNavItem(SvgPicture _image, {String badge = " "}) {
    return Container(width: 50, height: 25, child: Stack(children: <Widget>[
      Align(
        alignment: Alignment.bottomCenter, child: _image),
      badge == "" ? Center() :
      Positioned(child: Badge(animationDuration: Duration(milliseconds: 0), animationType: BadgeAnimationType.fade, badgeContent: Text(badge, style: const TextStyle(
        color: Colors.white,
        fontSize: 12,
      ), )), right: 0, top: -2)
    ],));
    ...
    return [
      new NaviagationBottom(
        ...
        BottomNavigationBarItem(
          ...
          title: new Text(LocalizationsUtil.of(context).translate('Đơn hàng'),),
        )
      ),
      new NaviagationBottom(
        Text('Menu'),
        BottomNavigationBarItem(
          ...
          title: Text(LocalizationsUtil.of(context).translate('Menu'),),
        )
      ),
      new NaviagationBottom(
       Text('Ưu đãi'),
        BottomNavigationBarItem(
          ...
          title: Text(LocalizationsUtil.of(context).translate('Ưu đãi'),),
        )
      ),
      new NaviagationBottom(
       Text('Cửa hàng'),
        BottomNavigationBarItem(
          ...
          title: Text(LocalizationsUtil.of(context).translate('Cửa hàng'),),
        )
      ),
      new NaviagationBottom(
       Text('Cửa hàng'),
        BottomNavigationBarItem(
          ...
          title: Text(LocalizationsUtil.of(context).translate('Thêm'),),
        )
      ),
    ];
  }
              ...
              children: <Widget>[
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Text("${connected ? 'Đã kết nối mạng' : 'Không có kết nối mạng'}", style: TextStyle(fontSize: 14, color: Colors.white)),
                    ),
                  )),
              ],
            ),
